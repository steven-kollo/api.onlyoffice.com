...
- plugins: added the GetAllForms, GetFileToDownload, GetFormsByTag, GetFormValue, GetInstalledPlugins, InstallPlugin, RemovePlugin, SetFormValue and UpdatePlugin methods
