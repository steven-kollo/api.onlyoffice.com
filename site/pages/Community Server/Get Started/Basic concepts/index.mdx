...
order: -2
---
ONLYOFFICE Community Serverv12.6
...
Authentication in the ONLYOFFICE Workspace API is managed via the HTTP authentication, i.e. every request must include the Authorization HTTP header. For information and examples please visit the [Authentication](/portals/auth) section.
...
If you have any questions about ONLYOFFICE Workspace, try the [FAQ](/portals/faq) section first.

You can request a feature or report a bug by posting an issue on [GitHub](https://github.com/ONLYOFFICE/CommunityServer/issues).

You can also ask our developers on [ONLYOFFICE forum](https://forum.onlyoffice.com/c/workspace/33) (registration required).
