...
Calls the specified Document Builder method. See the [Text document API](/docbuilder/textdocumentapi), [Spreadsheet API](/docbuilder/spreadsheetapi), [Presentation API](/docbuilder/presentationapi), or [Form API](/docbuilder/formapi) sections for more information which methods are available for various document types.
