...
order: -1
---
# [](/plugin/macrosamples/)Import CSV/TXT data
...
Methods used: [GetActiveSheet](/docbuilder/spreadsheetapi/api/getactivesheet), [GetCells](/docbuilder/spreadsheetapi/apiworksheet/getcells), [SetValue](/docbuilder/spreadsheetapi/apirange/setvalue)
