...
order: -9
---
# [](/plugin/macrosamples/)Next blank row
...
Methods used: [GetActiveSheet](/docbuilder/spreadsheetapi/api/getactivesheet), [GetRangeByNumber](/docbuilder/spreadsheetapi/apiworksheet/getrangebynumber), [Select](/docbuilder/spreadsheetapi/apirange/select)
