...
order: -10
---
# [](/plugin/macrosamples/)Highlight duplicates
...
Methods used: [CreateColorFromRGB](/docbuilder/spreadsheetapi/api/createcolorfromrgb) [GetActiveSheet](/docbuilder/spreadsheetapi/api/getactivesheet), [GetSelection](/docbuilder/spreadsheetapi/apiworksheet/getselection), [ForEach](/docbuilder/spreadsheetapi/apirange/foreach), [GetValue](/docbuilder/spreadsheetapi/apirange/getvalue), [SetFillColor](/docbuilder/spreadsheetapi/apirange/setfillcolor)
