...
order: -1
---
# [](/plugin/macrosamples/)Complete address information
...
Methods used: [GetActiveSheet](/docbuilder/spreadsheetapi/api/getactivesheet), [GetRange](/docbuilder/spreadsheetapi/apiworksheet/getrange), [SetValue](/docbuilder/spreadsheetapi/apirange/setvalue), [GetText](/docbuilder/spreadsheetapi/apirange/gettext)
