...
order: -7
---
# [](/plugin/macrosamples/)Currency exchange rates
...
Methods used: [GetSheet](/docbuilder/spreadsheetapi/api/getsheet), [GetRangeByNumber](/docbuilder/spreadsheetapi/apiworksheet/getrangebynumber), [SetValue](/docbuilder/spreadsheetapi/apirange/setvalue)
