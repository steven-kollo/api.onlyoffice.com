...
You can find more information about the *.docbuilder* file syntax [here](/docbuilder/integrationapi/usingdocbuilderfile). Please read **ONLYOFFICE Document Builder** [API documentation](/docbuilder/gettingstarted) for the detailed information on what classes and methods are used to generate the documents with the help of *.docbuilder* files.
