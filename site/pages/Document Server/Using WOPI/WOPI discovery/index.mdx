...
| convert   | Converts a document in a [binary format](/editors/wopi/editingbinary) (*doc, ppt, xls*) into a modern format (*docx, pptx, xlsx*) so that it can be edited in the online office. |
