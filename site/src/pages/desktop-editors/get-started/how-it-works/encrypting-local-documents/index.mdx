---
title: Encrypting Local Documents
order: -1
---
...
More information about the plugin structure can be found [here](/plugins-and-macros/get-started/plugin-structure).
...
![Encryption exabled](./_static/encryption-enabled.png)
