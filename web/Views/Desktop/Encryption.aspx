...
typeof window.AscDesktopEditor.cloudCryptoCommand === "function"
    ...
    <h2>How it works</h2>
    <p>The scheme and steps below explain the process of document encryption in ONLYOFFICE.</p>
    <img alt="Keys generation" src="<%= Url.Content("~/content/img/desktop/keys-generation.png") %>" />    
...
...
        ...
        <li>
            <p>To monitor the password from the login page, send the desktop editors the <em>portal:checkpwd</em> command through the <a href="<%= Url.Action("loginlogout") %>">execCommand</a> method. 
...
window.cloudCryptoCommand = function (type, params, callback) 
    ...
    <img alt="Uploading encrypted file" src="<%= Url.Content("~/content/img/desktop/uploading.png") %>" />
...
callback({
    ...
    <img alt="Sharing encrypted file" src="<%= Url.Content("~/content/img/desktop/sharing.png") %>" />
