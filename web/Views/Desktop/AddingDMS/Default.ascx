...
<ol>
    <li>
        ...
        <img alt="Connection list" src="<%= Url.Content("~/content/img/desktop/connection-list.png") %>" />
    </li>
    <li>
        ...
        <img alt="Provider button" src="<%= Url.Content("~/content/img/desktop/provider-button.png") %>" />
    </li>
</ol>
