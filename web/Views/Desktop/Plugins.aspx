...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <img alt="Plugin settings" src="<%= Url.Content("~/content/img/desktop/plugin-settings.png") %>" />

    <p><b>Step 3.</b> In the plugin <b>Settings</b> window, click the <b>Add plugin</b> button to load your created archive:</p>
    <img alt="Adding plugin" src="<%= Url.Content("~/content/img/desktop/adding-plugins.png") %>" />
    ...
    <img alt="Plugins tab" src="<%= Url.Content("~/content/img/desktop/plugins-tab.png") %>" />
    ...
    <pre>
{
    ...
    <img alt="Plugin folder" src="<%= Url.Content("~/content/img/desktop/plugins-folder.png") %>" />
    ...
    <img alt="Extended comments" src="<%= Url.Content("~/content/img/desktop/extended-comments.png") %>" />
