...
var docEditor = new DocsAPI.DocEditor("placeholder", {
    ...
    <p>When the user saves the changes by clicking the <b>Save</b> button, the others will receive a note about updates.
        To accept them and save your own changes to show them to other users, click the <img alt="Save updates" src="<%= Url.Content("~/content/img/editor/save-updates.png") %>" /> button
