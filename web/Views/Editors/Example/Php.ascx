...
<p>The PHP example offers various installation options, but we highly recommend using Docker for this purpose.</p>
...
<p>Then open the example directory and <a href="https://github.com/ONLYOFFICE/document-server-integration/blob/880423545fc0c1f21b004e1c8121a319809f4b72/web/documentserver-example/php/Makefile#L60" target="_blank">up containers</a>:</p>
<pre>
cd "PHP Example"
make compose-prod
</pre>
<p>By default, the server starts at <em>localhost:80</em>.</p>
<p>To configure the example, you can edit the environment variables in <a href="https://github.com/ONLYOFFICE/document-server-integration/blob/880423545fc0c1f21b004e1c8121a319809f4b72/web/documentserver-example/php/docker-compose.yml" target="_blank">docker-compose.yml</a>.
...
Check the detailed guide to learn how to install it on <a href="https://helpcenter.onlyoffice.com/installation/docs-developer-install-windows.aspx?from=api_php_example" target="_blank">Windows</a>,
<a href="https://helpcenter.onlyoffice.com/installation/docs-developer-install-ubuntu.aspx?from=api_php_example" target="_blank">Linux</a>,
or <a href="https://helpcenter.onlyoffice.com/installation/docs-developer-install-docker.aspx?from=api_php_example" target="_blank">Docker</a>.</p>
<p>To run the example on your local machine, you will need <a href="https://www.php.net/" target="_blank">PHP 8.2.11</a>
with <a href="https://getcomposer.org/" target="_blank">Composer 2.6.5</a>. Additionally, you might want to consider installing <a href="https://www.gnu.org/software/make/" target="_blank">GNU Make 4.4.1</a>,
...
<p>Then open the example directory, <a href="https://github.com/ONLYOFFICE/document-server-integration/blob/880423545fc0c1f21b004e1c8121a319809f4b72/web/documentserver-example/php/Makefile#L16" target="_blank">install dependencies</a>,
and <a href="https://github.com/ONLYOFFICE/document-server-integration/blob/880423545fc0c1f21b004e1c8121a319809f4b72/web/documentserver-example/php/Makefile#L40" target="_blank">start the server</a>:</p>
<pre>
cd "PHP Example"
make prod
make server-prod
</pre>
<p>By default, the server starts at <em>0.0.0.0:9000</em>.</p>
...
<h2 id="configure" class="copy-link"><span class="style_step">Step 3. </span>Configure the PHP example</h2>
