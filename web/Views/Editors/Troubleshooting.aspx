...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>Check if the link to the file specified in the <a href="<%= Url.Action("config/document") %>#url">document.url</a> is correct. The link must be accessible from the <b>document editing service</b>.</p>
    ...
    <p>Check if the <a href="<%= Url.Action("config/editor") %>#callbackUrl">editorConfig.callbackUrl</a> link is correct. The saving in the <b>document manager</b> must be implemented through the <a href="<%= Url.Action("callback") %>#implement">Callback handler</a></p>
    ...
    <p>Check if the <a href="<%= Url.Action("callback") %>#implement">Callback handler</a> is working correctly. The <b>document storage service</b> must return <a href="<%= Url.Action("callback") %>#error-0">{"error": 0}</a> in response.</p>
