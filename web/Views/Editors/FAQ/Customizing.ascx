...
<dl class="faq_block" id="customizing_5">
    <dt>How to view and change the document additional parameters, e.g. its author or creation date?</dt>
    <dd>
        <p>The document author and creation date is affected by the <em>document.info.author</em> and <em>document.info.created</em> parameter respectively. You can pass these settings from some database of yours to the document configuration file the following way:</p>
        <pre>var docEditor = new DocsAPI.DocEditor("placeholder", {
    "document": {
        "info": {
            "author": "John Smith",
