...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p class="dscr">
        Document conversion service is a part of ONLYOFFICE Docs.
    ...
    <ol>
        ...
        <li>The <b>document storage service</b> sends the uploaded file to ONLYOFFICE Docs <b>document conversion service</b> for conversion into the Office Open XML format using the <a href="<%= Url.Action("conversionapi") %>">conversion API</a>.</li>
    ...
    <p>When the user needs to download the file in some format different from the Office Open XML format, ONLYOFFICE Docs converts the document file saved at the <b>document storage service</b> into the appropriate format prior to its export.</p>
    ...
    <ol>
        ...
        <li>The <b>document storage service</b> sends the uploaded file to ONLYOFFICE Docs <b>document conversion service</b> for conversion into the appropriate format using the <a href="<%= Url.Action("conversionapi") %>">conversion API</a>.</li>
