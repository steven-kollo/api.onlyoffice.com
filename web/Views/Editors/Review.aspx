...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p class="dscr">
        The <b>Review option</b> allows to review the document, change the sentences, phrases and other age elements, correct spelling, etc. without actually editing it.
    ...
    <h2 id="access-rights" class="copy-link">Access rights to reviewing</h2>
    <p>
    ...
    <p>
        In case <em>edit</em> parameter is set to <b>true</b> and <em>review</em> parameter is also set to <b>true</b>, the user will be able to edit the document, accept or reject the changes and switch to the review mode him-/herself.
    </p>
    <img alt="Reviewing" src="<%= Url.Content("~/content/img/editor/accept_reject.png") %>" />
    <p>
        In case <em>edit</em> parameter is set to <b>false</b> and <em>review</em> parameter is also set to <b>true</b>, the document will be available for reviewing only.
    </p>
    <pre>
...
var docEditor = new DocsAPI.DocEditor("placeholder", {
    ...
    ...
        ...
        <li>
            <p>
                Specify the group access rights by the <a href="<%= Url.Action("config/editor/customization") %>#reviewPermissions">reviewPermissions</a> parameter in the customization section of the editor initialization.
            </p>
            <div class="note">
                ...
                Otherwise, if the current user does not belong to any of the groups, he can review documents of all groups.
            </div>
            <pre>
var docEditor = new DocsAPI.DocEditor("placeholder", {
    "editorConfig": {
