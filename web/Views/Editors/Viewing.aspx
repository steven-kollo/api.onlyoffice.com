...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>Starting from version 7.2, the live viewer is added to the text document, spreadsheet and presentation editors.
    ...
    <ol>
        <li>
            <p>If the <em>mode</em> field is <em>fast</em> and the <em>change</em> field is <em>true</em>, then the live viewer is opened by default,
                but you can switch the mode to the offline viewer and back without reloading the page.
...
"coEditing": {
    ...
    "change": true
        ...
        <li>
            <p>If the <em>mode</em> field is <em>fast</em> and the <em>change</em> field is <em>false</em>, then the live viewer is opened by default, and you cannot switch the mode to the offline viewer:</p>
            <pre>
"coEditing": {
    "mode": "fast",
    "change": false
        ...
        <li>
            <p>If the <em>mode</em> field is <em>strict</em> and the <em>change</em> field is <em>true</em>, then the offline viewer is opened by default,
...
"coEditing": {
    ...
    "change": true
        ...
        <li>
            <p>If the <em>mode</em> field is <em>strict</em> and the <em>change</em> field is <em>false</em>, then the offline viewer is opened by default, and you cannot switch the mode to the live viewer:</p>
            <pre>
"coEditing": {
    "mode": "strict",
    "change": false
    ...
    <p>In the following cases, only the offline viewer is used:</p>
    <ul>
    ...
    <p>The concept for working with viewing modes in the mobile editors is the same as for the web version. But the user cannot change the viewing mode
        (there is no <b>Show changes from other users</b> option in the <b>Advanced Settings...</b>).</p>
</asp:Content>
