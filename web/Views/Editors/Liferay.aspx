...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>该 <a href="https://github.com/ONLYOFFICE/onlyoffice-liferay" target="_blank">插件</a> 使用户可以从 <a href="https://www.liferay.com/" target="_blank">Liferay</a> 中使用 ONLYOFFICE 文档编辑办公文档。</p>
    ...
    <p>从 7.2 版开始，默认情况下启用 JWT，并自动生成密钥以限制对 ONLYOFFICE 文档的访问，这也是出于安全原因和数据完整性考虑。
        在 Liferay <b>系统设置</b> 页面上指定您自己的<b>密钥</b>。 在 ONLYOFFICE 文档 <a href="/editors/signature/">配置文件</a>中，指定相同的密钥并启用验证。</p>
    ...
    <ol>
        ...
        <li>
            ...
            <ul>
                ...
                <li><b>key</b>: <em>fileVersionId</em> 指示ONLYOFFICE 文档是否重新下载文档；</li>
                <li><b>title</b>：文档标题（名称）。</li>
            </ul>
        </li>
        <li>客户端浏览器从 ONLYOFFICE 文档向 JavaScript 库发出请求，并向 ONLYOFFICE 文档发送具有上述属性的 DocEditor 配置。</li>
        <li>然后 ONLYOFFICE 文档从 Liferay 下载文档，用户开始编辑。然后 ONLYOFFICE 文档从 HumHub 下载文档，用户开始编辑。</li>
        <li>ONLYOFFICE 文档向 <i>callbackUrl</i> 发送 POST 请求，通知 HumHub 用户正在编辑文档。</li>
        <li>ONLYOFFICE 文档向回调URL 发送 POST 请求，以通知 Liferay 用户正在编辑文档。</li>
        <li>当所有用户和客户端浏览器都完成编辑后，他们会关闭编辑窗口。</li>
        <li>在 <a href="<%= Url.Action("save") %>#savedelay">10 秒</a> 不活动后，ONLYOFFICE 文档向回调URL 发送一个 POST，让 Liferay 知道客户端已完成对文档的编辑并关闭它。</li>
