...
<h1>
    <span class="hdr">Vue samples</span>
</h1>

<p class="dscr">
    In the Vue application that you've created using these <a href="<%= Url.Action("vue/") %>">instructions</a>,
    you can install <a href="https://storybook.js.org/" target="_blank">Storybook</a> and create various UI components.
    To enable interaction between the UI components of the Vue application and the ONLYOFFICE editors, we will use the <a href="<%= Url.Action("connector") %>">Automation API</a>.
...
<p>You can find some ready-made Vue components in this <a href="https://github.com/ONLYOFFICE/document-editor-vue-samples" target="_blank">repository</a>:</p>
<ul>
    <li><a href="https://github.com/ONLYOFFICE/document-editor-vue-samples/tree/master/src/components/Comments" target="_blank">Working with comments</a></li>
    <li><a href="https://github.com/ONLYOFFICE/document-editor-vue-samples/tree/master/src/components/Review" target="_blank">Working with review changes</a></li>
    <li><a href="https://github.com/ONLYOFFICE/document-editor-vue-samples/tree/master/src/components/ContentControls" target="_blank">Filling out forms</a></li>
</ul>

<p>Let's see how to create Vue components and use them.</p>

<h2 id="prerequisites" class="copy-link">Install the prerequisites</h2>
<ol>
    <li>
        <p>Go to the Vue project directory:</p>
        <pre>
        ...
        <pre>
{
  ...
  "exclude": [
    ...
    <li>
        <p>Add the <em>vue.config.js</em> file to the root folder with the following content</p>
        <pre>
...
<h2 id="create-component" class="copy-link">Create Vue components</h2>
<p>Let's start developing Vue components.</p>
<ol>
    <li>
        ...
        <pre>
{
    ...
    <li>For each component, create a separate folder in the <em>src/components</em> directory. In our example, we create three folders:
        <em>Comments</em>, <em>ContentControls</em>, and <em>Review</em>. All the related files will be placed in these folders (<em>css</em> files, <em>vue</em> files, etc.).</li>
    <li>
...
export default {
  ...
  "argTypes": {
    ...
    "events_onRequestRestore": { "action": "onRequestRestore" }
                ...
                <p>You can find descriptions for the Vue component properties <a href="<%= Url.Action("vue/") %>#api">here</a>.</p>
            </li>
            <li>
                <p>Create the named exports to build out the Document Editor four states: FormTemplate, DocumentTemplate, SpreadsheetTemplate, and PresentationTemplate.
                    You can find the code for each story <a href="https://github.com/ONLYOFFICE/document-editor-vue-samples/blob/master/src/DocumentEditor.stories.js" target="_blank">here</a>.
...
yarn storybook
    ...
    <img class="screenshot max-width-832" alt="Document editor component" src="<%= Url.Content("~/content/img/editor/vue/document-editor-component.png") %>" />
</ol>
