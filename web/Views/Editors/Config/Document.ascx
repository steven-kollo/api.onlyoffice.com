    ...
    <tbody>
        <tr class="tablerow">
            ...
            <td>
                ...
                Must be lowercase.
                The following file types are available: <em>.csv, .djvu, .doc, .docm, .docx, .dot, .dotm, .dotx, .epub, .fb2, .fodp, .fods, .fodt, .htm, .html, .mht, .odp, .ods, .odt, .otp, .ots, .ott, .oxps, .pdf, .pot, .potm, .potx, .pps, .ppsm, .ppsx, .ppt, .pptm, .pptx, .rtf, .txt, .xls, .xlsb, .xlsm, .xlsx, .xlt, .xltm, .xltx, .xml, .xps</em>.
            </td>
            <td>string</td>
            <td>"docx"</td>
        </tr>
