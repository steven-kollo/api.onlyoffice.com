...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <note>
        ...
        <p>
            ...
            <a href="<%= Url.Action("methods") %>#setReferenceData">setReferenceData</a>, <a href="<%= Url.Action("methods") %>#setRequestedDocument">setRequestedDocument</a>,
            <a href="<%= Url.Action("methods") %>#setRequestedSpreadsheet">setRequestedSpreadsheet</a>, <a href="<%= Url.Action("methods") %>#setRevisedFile">setRevisedFile</a>.
