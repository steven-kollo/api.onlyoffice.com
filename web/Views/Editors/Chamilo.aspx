...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p class="dscr">This <a href="https://github.com/ONLYOFFICE/onlyoffice-chamilo/tree/master" target="_blank">plugin</a> enables users to edit office documents from 
        <a href="https://chamilo.org/en/" target="_blank">Chamilo</a> using ONLYOFFICE Docs.</p>

    <p>The app is compatible with Chamilo v1.11.14 or newer.</p>
    ...
    <ul>
        ...
        <li>Co-edit documents in real-time: use two co-editing modes (<b>Fast</b> and <b>Strict</b>), the <b>Track Changes</b> mode, comments, and built-in chat.</li>
    </ul>
    ...
    <p>
        Starting with version 4.3.0, ONLYOFFICE Docs and Chamilo can be installed either on different computers, or on the same machine. 
    ...
    <p>
        ...
        The address must be accessible for the user browser and from the Chamilo server.
    ...
    <p>To create a new file, the user opens the necessesary folder and clicks the <b>Create new</b> ONLYOFFICE icon.</p>
    <p>The user is redirected to the file creation page where they need to enter the file name and format (text document, spreadsheet, or presentation). 
        The browser calls <em>/plugin/onlyoffice/create.php</em> method. It adds the copy of the empty file to the user folder.</p>
    <p>To open an existing file, the user chooses the <b>Open with ONLYOFFICE</b> icon.</p>
    <p>The request is being sent to <em>/plugin/onlyoffice/editor.php?docId="document identificator"</em>. 
        The server processes the request, generates the editor initialization configuration with the properties:</p>
    <ul>
    ...
    <br />
    <p>Download the ONLYOFFICE Chamilo plugin <a href="https://github.com/ONLYOFFICE/onlyoffice-chamilo/tree/master" target="_blank">here</a>.</p>
