...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>Tested with ownCloud 9 and 10.</p>
    ...
    <div class="note note-important">
        ...
        ONLYOFFICE Document Server and ownCloud <b>must</b> be installed on <b>different</b> computers, otherwise problems might occur and no correct connector work can be guaranteed.
    </div>
...
git clone https://github.com/ONLYOFFICE/onlyoffice-owncloud.git onlyoffice</span>
    ...
    <h2 id="settings">Configuring ownCloud ONLYOFFICE integration app</h2>
    <p>
    ...
    <p id="masterKey">
        ...
        Unfortunately if you enable the encryption with the per-user encryption keys (used by default in ownCloud) <b>ONLYOFFICE Document Server</b> cannot open the encrypted files for editing and save them after the editing.
        ...
        The instruction on enabling master key based encryption is available in the official documentation on <a href="https://doc.owncloud.org/server/latest/admin_manual/configuration_files/encryption_configuration.html#enabling-master-key-based-encryption" target="_blank">ownCloud</a> website.
    </p>
    <div class="note note-important">
        <div class="note-important-label">Please note</div>
    ...
    <p>After <a href="<%= Url.Action("save") %>#tenseconds">10 seconds</a> of inactivity, ONLYOFFICE Document Server sends a POST to the <em>callback</em> URL letting ownCloud know that the clients have finished editing the document and closed it.</p>
