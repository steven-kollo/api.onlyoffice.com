...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>Tested with Nextcloud 11 and 12.</p>
    ...
    <div class="note note-important">
        ...
        ONLYOFFICE Document Server and Nextcloud <b>must</b> be installed on <b>different</b> computers, otherwise problems might occur and no correct connector work can be guaranteed.
    </div>
    ...
    <p>To start using ONLYOFFICE Document Server with Nextcloud, the following steps must be performed:</p>
    <ol>
        <li>Place Nextcloud ONLYOFFICE integration app to your Nextcloud server into the <em>apps/</em> (or some other) directory, used to connect applications:
            <span class="commandline">cd apps/
git clone https://github.com/ONLYOFFICE/onlyoffice-nextcloud.git onlyoffice</span>
        </li>
    ...
    <h2 id="settings">Configuring Nextcloud ONLYOFFICE integration app</h2>
    <p>
    ...
    <p id="masterKey">
        ...
        Unfortunately if you enable the encryption with the per-user encryption keys (used by default in Nextcloud) <b>ONLYOFFICE Document Server</b> cannot open the encrypted files for editing and save them after the editing.
        ...
        The instruction on enabling master key based encryption is available in the official documentation on <a href="https://docs.nextcloud.com/server/12/admin_manual/configuration_files/encryption_configuration.html#occ-encryption-commands" target="_blank">Nextcloud</a> websites.
    </p>
    <div class="note note-important">
        <div class="note-important-label">Please note</div>
        Nextcloud recommends using master encryption key only on fresh installations with no existing data, or on systems where encryption has not already been enabled, as your files previously encrypted with the use of per-user encryption keys <b>might be lost forever</b> after you enable master key based encryption on them.
    </div>
    ...
    <p>After <a href="<%= Url.Action("save") %>#tenseconds">10 seconds</a> of inactivity, ONLYOFFICE Document Server sends a POST to the <em>callback</em> URL letting Nextcloud know that the clients have finished editing the document and closed it.</p>
