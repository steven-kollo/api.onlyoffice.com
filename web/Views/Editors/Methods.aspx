...
var docEditor = new DocsAPI.DocEditor("placeholder", config);
    ...
    <ul>
        <li><a href="#createConnector">createConnector</a> - create the connector to work with the editor from the outside.</li>
    ...
    <ul>
        <li>
            <p>
                <b id="createConnector" class="copy-link">createConnector</b><span class="required">*</span> - create the <a href="<%= Url.Action("connector") %>">connector</a> to work with the editor from the outside.
            </p>
            <pre>
