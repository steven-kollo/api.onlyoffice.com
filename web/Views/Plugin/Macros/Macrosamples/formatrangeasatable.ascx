...
<a href="<%= Url.Action("spreadsheetapi/apiworksheet/formatastable", "docbuilder") %>">FormatAsTable</a>
</p>
...
<img alt="Range as a table" src="<%= Url.Content("~/content/img/plugins/range-as-a-table.png") %>" />
