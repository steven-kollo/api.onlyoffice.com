...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p class="dscr">Macros are small scripts used to facilitate your day-to-day routine work with different types of documents. 
        ONLYOFFICE macros use the JavaScript syntax and <b>ONLYOFFICE Document Builder</b> <a href="<%= Url.Action("textdocumentapi", "docbuilder") %>">API</a> scripting notation.</p>
    ...
    <ol>
        ...
        <li>Consult the <a href="<%= Url.Action("textdocumentapi", "docbuilder") %>">API documentation</a> to write the script.</li>
