...
<ul class="plugin-block">
    ...
    <li class="plugin-example" data-types="text-editor,visual,non-system">
        <a href="<%= Url.Action("example/mendeley") %>"><div class="example-plug-img mendeley"></div></a>
            <div class="plugin-info">
                <p class="name-example-plugin"><a href="<%= Url.Action("example/mendeley") %>">Mendeley</a></p>
                <p>Allows  the user to connect the Mendeley account.</p>
            </div>
        <p class="block_more plug_more"><a href="<%= Url.Action("example/mendeley") %>">More</a></p>
    </li>
    <li class="plugin-example" data-types="text-editor,spreadsheet,presentation,visual,non-system">
        <a href="<%= Url.Action("example/translator") %>"><div class="example-plug-img translator-example"></div></a>
            <div class="plugin-info">
                <p class="name-example-plugin"><a href="<%= Url.Action("mexample/translator") %>">Translator</a></p>
    ...
    <li class="plugin-example" data-types="text-editor,visual,non-system">
        <a href="<%= Url.Action("example/exampleaddcontentcontrols") %>"><div class="example-plug-img example-add"></div></a>
            <div class="plugin-info">
                <p class="name-example-plugin"><a href="<%= Url.Action("example/exampleaddcontentcontrols") %>">Example add content controls</a></p>
                <p>Allows the user to add content controls into the document.</p>
            </div>
        <p class="block_more plug_more"><a href="<%= Url.Action("example/exampleaddcontentcontrols") %>">More</a></p>
    </li>
    <li class="plugin-example" data-types="spreadsheet,non-visual,non-system">
