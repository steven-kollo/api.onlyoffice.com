...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p class="dscr">Defines the <em>window.Asc.plugin</em> object method that allows returning the result of the previously executed method. It can be used to return data after executing the <a href="<%= Url.Action("executemethod") %>">window.Asc.plugin.executeMethod(...)</a> method.</p>
