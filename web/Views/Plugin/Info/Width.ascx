...
NB:<div class="note">If the pixel width size of the OLE object is needed for raster representation, it is necessary to use the <a href="<%= Url.Action("info/mmtopx") %>">window.Asc.plugin.info.mmToPx</a> method to convert the values.</div>
