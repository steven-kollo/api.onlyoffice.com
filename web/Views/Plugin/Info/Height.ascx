...
<h1>
    ...
    <span class="hdr">window.Asc.plugin.info.height</span>
...
<div class="note">If you need the OLE object pixel height size for the raster representation, use the <a class="underline" href="<%= Url.Action("info/mmtopx") %>">window.Asc.plugin.info.mmToPx</a> method to convert the values.</div>
