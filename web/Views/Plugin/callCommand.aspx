...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p class="dscr">Defines the method used to send the data back to the editor. It replaces the <a href="<%= Url.Action("executeCommand") %>">executeCommand</a> method 
        ...
        It allows the plugin to send structured data that can be inserted into the resulting document file (formatted paragraphs, tables, text parts, and separate words, etc.).</p>
    ...
    <p>This method is executed in its context isolated from other JavaScript data. If some parameters or other data need to be passed to this method, use <a href="<%= Url.Action("scope") %>">Asc.scope</a> object.</p>
