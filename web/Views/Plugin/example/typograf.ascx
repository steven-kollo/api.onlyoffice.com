...
<p>You can also download this plugin from the <a href="https://www.onlyoffice.com/en/app-directory/typograph" target="_blank">ONLYOFFICE App Directory</a> and install it using the
