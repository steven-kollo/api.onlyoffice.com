...
<ul>
    ...
    <li>"objectId" (e.g. <em>{"objectId": "1_001"}</em>) is an OLE object program identifier which must be of the <em>asc.{UUID}</em> type;</li>
...
<pre>
window.Asc.plugin.executeMethod("EditOleObject", [{"width": 70, "height": 70, "data": "{data}", "guid": "asc.{UUID}", "imgSrc": "{link}", "widthPix": 60 * 36000, "heightPix": 60 * 36000}]);
</pre>
