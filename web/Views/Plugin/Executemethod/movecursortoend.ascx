...
<p class="dscr">Defines the method that allows moving a cursor to the end of the current editing area (document body, footer/header, footnote, or autoshape).
...
<table class="table">
    ...
    <tbody>
        <tr class="tablerow">
            ...
            <td>This flag ignores the current position and always moves a cursor to the end of the document body.</td>
            <td>boolean</td>
            <td>true</td>
        </tr>
    </tbody>
