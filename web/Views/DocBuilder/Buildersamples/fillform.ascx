...
<%@ Register TagPrefix="UserControl"
    ...
    <p>This script fills <a href="<%= Url.Action("buildersamples/createadvancedform") %>">advanced form</a> from another builder sample with data stored in an object.<br />You can edit script, run it again with the <b>start script</b> button and see updated result.</p>
