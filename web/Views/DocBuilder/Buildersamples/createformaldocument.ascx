...
<%@ Register TagPrefix="UserControl"
    ...
    <p>This script uses paragraph styles, tables, header, footer and more to create formal document.<br />You can edit script, run it again with the <b>start script</b> button and see updated result.</p>
