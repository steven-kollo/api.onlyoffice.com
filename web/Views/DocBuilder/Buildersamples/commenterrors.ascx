...
<%@ Register TagPrefix="UserControl"
    ...
    <p>This script checks all used cells for formula errors like "#DIV/0!" and comments each error. After script finishing you can simply find and fix errors.<br />You can edit script, run it again with the <b>start script</b> button and see updated result.</p>
