...
<%@ Register TagPrefix="UserControl"
    ...
    <p>This script fills an empty spreadsheet with data stored in arrays.<br />You can edit script, run it again with the <b>start script</b> button and see updated result.</p>
