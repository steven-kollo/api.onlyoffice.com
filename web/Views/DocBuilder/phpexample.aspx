...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ol>
        <li>
            ...
            <img class="screenshot max-width-550" src="<%= Url.Content("~/content/img/php/manager.png") %>" alt="">
            ...
            <img class="screenshot max-width-550" src="<%= Url.Content("~/content/img/php/php-version-1.jpg") %>" width="700" alt="" />

            <p>After clicking <b>OK</b> the new <b>PHP version</b> will be registered with IIS and will become active.</p>
            <img class="screenshot max-width-550" src="<%= Url.Content("~/content/img/php/php-version-2.jpg") %>" width="650" alt="" />
        </li>
        <li>
            ...
            <img class="screenshot max-width-550" src="<%= Url.Content("~/content/img/php/handlerclick.png") %>" alt="" />
            ...
            <img class="screenshot max-width-550" src="<%= Url.Content("~/content/img/php/handler-add.png") %>" alt="" />
        </li>
    </ol>
    ...
    <ol>
        ...
        <li>
            ...
            <img class="screenshot max-width-550" alt="" src="<%= Url.Content("~/content/img/docbuilder/php-add.png") %>" />
        </li>
        <li>
