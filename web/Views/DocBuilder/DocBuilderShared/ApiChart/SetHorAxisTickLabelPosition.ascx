...
<h4 class="header-gray" id="SetHorAxisTickLabelPosition">SetHorAxisTickLabelPosition(sTickLabelPosition)</h4>
<p class="dscr">
...
<table class="table">
    ...
    <tbody>
        <tr class="tablerow">
            ...
            <td>Set the position of the chart horizontal tick labels.</td>
        </tr>
    </tbody>
</table>