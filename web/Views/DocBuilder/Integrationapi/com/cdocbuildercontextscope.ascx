...
All opened scopes will be closed automatically when the builder <a href="<%= Url.Action("integrationapi/com/cdocbuilder/closefile") %>">CloseFile</a> method is called.</p>
