...
<h4 class="header-gray" id="OpenFile">HRESULT OpenFile([in] BSTR path, [in] BSTR params, [out, retval] VARIANT_BOOL* result);</h4>
...
<table class="table">
    ...
    <tbody>
        ...
        <tr class="tablerow">
            <td><em>result</em></td>
            <td>VARIANT_BOOL*</td>
            <td>Specifies if the operation of opening a file is successful or not.</td>
        </tr>
    </tbody>
</table>
