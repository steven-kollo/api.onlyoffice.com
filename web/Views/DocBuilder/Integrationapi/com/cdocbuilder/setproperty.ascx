...
<h4 class="header-gray" id="SetProperty">HRESULT SetProperty([in] BSTR key, [in] BSTR value);</h4>

<p class="dscr">Sets an argument to the builder class which can be trasferred to the program outside the <a href="<%= Url.Action("integrationapi/com/cdocbuilder/executecommand") %>">CDocBuilder.ExecuteCommand</a> method,
