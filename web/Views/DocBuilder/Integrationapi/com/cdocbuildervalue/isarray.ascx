...
<h4 class="header-gray" id="CloseFile">HRESULT IsArray([out, retval] VARIANT_BOOL* result);</h4>
...
<table class="table">
    ...
    <tbody>
        <tr class="tablerow">
            <td><em>result</em></td>
            <td>VARIANT_BOOL*</td>
            <td>Specifies whether the <b>CDocBuilderValue</b> object is an array.</td>
        </tr>
    </tbody>
</table>
