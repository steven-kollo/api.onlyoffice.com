...
<h4 class="header-gray" id="CloseFile">HRESULT IsString([out, retval] VARIANT_BOOL* result);</h4>
...
<table class="table">
    ...
    <tbody>
        <tr class="tablerow">
            <td><em>result</em></td>
            <td>VARIANT_BOOL*</td>
            <td>Specifies whether the <b>CDocBuilderValue</b> object is a string.</td>
        </tr>
    </tbody>
</table>
