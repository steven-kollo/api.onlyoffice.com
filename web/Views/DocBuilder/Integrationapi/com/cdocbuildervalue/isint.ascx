...
<h4 class="header-gray" id="CloseFile">HRESULT IsInt([out, retval] VARIANT_BOOL* result);</h4>
...
<table class="table">
    ...
    <tbody>
        <tr class="tablerow">
            <td><em>result</em></td>
            <td>VARIANT_BOOL*</td>
            <td>Specifies whether the <b>CDocBuilderValue</b> object is an integer.</td>
        </tr>
    </tbody>
</table>
