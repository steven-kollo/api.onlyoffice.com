...
All opened scopes will be closed automatically when the builder <a href="<%= Url.Action("integrationapi/c/cdocbuilder/closefile") %>">CloseFile</a> method is called.</p>
