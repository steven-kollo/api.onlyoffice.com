...
<p class="dscr">Runs all the commands for the document creation using a single command in the UTF8 format.
...
<table class="table">
    ...
    <tbody>
        <tr class="tablerow">
            ...
            <td>The commands in the UTF8 format which will be used to create the document file (in C++, the escape character must be used when the command contains quotation symbols).
