...
<h1>
   <span class="hdr">SetPropertyW</span>
</h1>

<h4 class="header-gray" id="SetPropertyW">void SetPropertyW(sParam, sValue);</h4>

<p class="dscr">Sets an argument in the Unicode format which can be trasferred to the program outside the <a href="<%= Url.Action("integrationapi/c/cdocbuilder/executecommand") %>">CDocBuilder.ExecuteCommand</a> method,
...
<div class="note">Please note, that for the <em>.docbuilder</em> file the <em>CDocBuilder.SetPropertyW</em> method is not used explicitly. The argument itself is used instead as an additional property for the executable. See the example below.</div>
...
<table class="table">
    ...
    <tbody>
        <tr class="tablerow">
            <td><em>sParam</em></td>
            <td>const&nbsp;wchar_t*</td>
            <td>The parameter name in the Unicode format, the value is always <em>--argument</em>.</td>
        </tr>
        <tr class="tablerow">
            <td><em>sValue</em></td>
            <td>const&nbsp;wchar_t*</td>
            <td>The parameter value in the Unicode format which will be used in the document.</td>
        </tr>
    </tbody>
</table>
