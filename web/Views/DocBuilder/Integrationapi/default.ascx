...
<ol>
    <li>
        ...
        <ul>
            ...
            <li>
            <a href="<%= Url.Action("integrationapi/cdocbuilder") %>">CDocBuilder</a> class - used by <b>ONLYOFFICE Document Builder</b> for the document file (text document, spreadsheet, PDF) to be generated.
            </li>
         </ul>
        <p>Visit the <a href="<%= Url.Action("integrationapi/cdocbuilder") %>">CDocBuilder</a> class section to find out more about the methods used for the <b>ONLYOFFICE Document Builder</b> integration using this option and for the C++ example.</p>
     </li>
     <li>
...
<p>See the examples in some of the most popular programming languages at <a href="<%= Url.Action("integratingdocumentbuilder") %>">this page</a>. More examples will be available there with the nearest <b>ONLYOFFICE Document Builder</b> API documentation website update.</p>
