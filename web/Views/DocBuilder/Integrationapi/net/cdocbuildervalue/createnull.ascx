...
<p class="dscr">Creates a null value. This method returns the current <a href="<%= Url.Action("integrationapi/net/cdocbuildercontext") %>">context</a>
and calls its <a href="<%= Url.Action("integrationapi/net/cdocbuildercontext/createnull") %>">CreateNull</a> method.</p>
