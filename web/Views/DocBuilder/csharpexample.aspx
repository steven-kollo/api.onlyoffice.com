    ...
    <h2 id="introduction">Introduction</h2>
            ...
            <ol>
                <li>
                    ...
                    <img alt="How to integrate ONLYOFFICE Document Builder into your application on .Net (C#)" src="/content/img/docbuilder/csharp/net46.png">
                ...
                <li>
                    ...
                    <img alt="How to integrate ONLYOFFICE Document Builder into your application on .Net (C#)" src="/content/img/docbuilder/csharp/add.png">
                </li>
                <li>
                    ...
                    <img alt="How to integrate ONLYOFFICE Document Builder into your application on .Net (C#)" src="/content/img/docbuilder/csharp/sitename.png">
                </li>
                <li>
                    ...
                    <img alt="How to integrate ONLYOFFICE Document Builder into your application on .Net (C#)" src="/content/img/docbuilder/csharp/platform.png">
                </li>
                <li>
                    ...
                    <img alt="How to integrate ONLYOFFICE Document Builder into your application on .Net (C#)" src="/content/img/docbuilder/csharp/browse.png">
                </li>
            </ol>
