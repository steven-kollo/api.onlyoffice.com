...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2 id="Integration"><a href="<%= Url.Action("integrationapi") %>">Integration API</a></h2>
    ...
    <table class="table table-classlist">
        ...
        <tbody>
            ...
            <tr class="tablerow">
                ...
                <td>The argument which can be trasferred to the program outside the <a href="<%= Url.Action("integrationapi/c/cdocbuilder/executecommand") %>">CDocBuilder.ExecuteCommand</a> method.</td>
            </tr>
            <tr class="tablerow">
