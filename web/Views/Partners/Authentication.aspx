...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<p class="dscr">An http header is required to pass the authentication when performing the API request. The authentication requires the partner token to be used in the <em>Authorization</em> header of the http request. This token is unique for each partner and can be found at the following page: <a href="http://partners.onlyoffice.com/office#/partnersapi" target="_blank">http://partners.onlyoffice.com/office#/partnersapi</a> in the <b>Authentication Token</b> field (it will look like this: <em>ASC2 59ce3f5b-3e33-4539-87d9-c273bc656135:20131217091618:nn00000anUEKUkZGG0OfeK9gwwE1</em>).</p>
...
request.Headers.Add("Authorization", "ASC2 59ce3f5b-3e33-4539-87d9-c273bc656135:20131217091618:nn00000anUEKUkZGG0OfeK9gwwE1");
	...
	<p>For the keys generation as hmac-sha1 key the partner private key is used. The private and the public keys can be found in the <b>Lead Generation</b> section of the <a href="https://partners.onlyoffice.com/office#/leads" target="_blank">ONLYOFFICE™ Partners Program</a> web site.</p>
