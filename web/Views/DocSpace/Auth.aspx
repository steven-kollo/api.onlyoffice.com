...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ol>
        <li>Send POST request, containing two parameters: <b>userName</b> and <b>password</b>, to the <a href="<%= Url.DocUrl("authentication", null, "post", "api/2.0/authentication", "docspace") %>">api/2.0/authentication</a> address
