...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        ...
        <br/>
        I.e. the request <a href="<%= Url.DocUrl("people", null, "get", "api/2.0/people", "docspace") %>">api/2.0/people</a> can be appended with several parameters, 
        for example <a href="<%= Url.DocUrl("people", null, "get", "api/2.0/people", "docspace") %>">api/2.0/people?startIndex=10&amp;count=25</a>
    </p>
    <table class="table">
        <colgroup>
        ...
        <tbody>
            ...
            <tr class="tablerow">
                ...
                <td>
                    ...
                    <a href="<%= Url.DocUrl("people", null, "get", "api/2.0/people", "docspace") %>">api/2.0/people?sortBy=userName&amp;sortOrder=descending</a>                 
                </td>
            </tr>
            <tr class="tablerow">
                <td>filterBy</td>
            ...
            <tr class="tablerow">
                ...
                <td>
                    ...
                    <a href="<%= Url.DocUrl("people", null, "get", "api/2.0/people", "docspace") %>">api/2.0/people?filterBy=userName&amp;filterOp=startsWith&amp;filterValue=Alex</a>                 
                </td>
            </tr>
            <tr class="tablerow">
                <td>updatedSince</td>
