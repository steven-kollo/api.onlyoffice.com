...
<p>Here are the fundamental steps for building plugins:</p>
<ol>
    <li>Preparing</li>
...
npx create-docspace-plugin
    ...
    <li>
        <p>Select the plugin scopes from the list by pressing <em>Space</em> on the necessary scopes (API, Settings, Context menu, etc.).</p>
    </li>
</ol>
...
(if this was not done previously in step 2). After that collect a plugin archive by running the <b>yarn build</b> command.
The completed plugin will be located in the <em>dist</em> folder and can be uploaded to the DocSpace portal.
