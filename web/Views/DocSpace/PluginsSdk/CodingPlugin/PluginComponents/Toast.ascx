...
<p>To change the toast type, use <a href="https://github.com/ONLYOFFICE/onlyoffice-docspace-plugin-sdk/blob/develop/src/interfaces/components/IToast.ts" target="_blank">ToastType</a> (<em>success, error, warning, info</em>).</p>
